...
with tabs[0]:
    ...
    ms_selected = st.multiselect("Select the Middle School courses you took:", courses, default=courses)
...
with tabs[1]:
    ...
    hs_selected = st.multiselect("Select the High School courses you are taking:", courses, default=courses)
